...
<body>
            ...
            <div class="col col-md-3 col-lg-3">
                <div role="tablist" id="accordion-1" style="margin-top: 16px;">
                    <div class="card">
                        ...
                        <div class="collapse item-1" role="tabpanel" data-parent="#accordion-1 .item-1">
                            <div class="card-body">
   <a href="<?= base_url('intelijen'); ?>">
                                ...
                                <a href="_laporan.html">
                                    <p class="card-text" style="font-size: 14px;margin-top: 0px;margin-bottom: 0px;">Perkembangan Laporan</p>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col col-md-6 col-lg-9">
                <h1 style="text-align: center; margin-bottom: 40px;">Penyuluhan Dan Penerangan Hukum</h1>
                <hr>

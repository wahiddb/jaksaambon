            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    <div class="site-heading">
                        ...
                        <h1 style="font-size: 50px;">Bidang Pidana Umum</h1><span class="subheading">Kejaksaan Negeri Ambon</span></div>
                </div>
            </div>
        </div>
    </header>
    <div class="container">
        <div class="row">
            ...
            <div class="col col-md-6 col-lg-9">
                <h1 style="text-align: center; margin-bottom: 40px;">Informasi Tilang</h1>
                <div class="card shadow" style="margin-top: 10px;">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 font-weight-bold">Data Tilang</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                ...
                                <thead>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><center> Kasubag </center></td>
                                      <td><center> Intelijen </center></td>

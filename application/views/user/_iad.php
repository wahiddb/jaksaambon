            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    <div class="site-heading">
                        <img class="mb-2" src="<?= base_url('assets'); ?>/img/IAD.jpeg" height="15%" width="15%">
                        <h1 style="font-size: 50px;">Ikatan Adyaksa Dharmakarini</h1><span class="subheading">Kejaksaan Negeri Ambon</span></div>
                </div>
            </div>
        </div>
    </header>
    <div class="container">
        <div class="row">
                ...
                <div role="tablist" id="accordion-1" style="margin-top: 16px;">
                    <div class="card">
                        ...
                        <div class="collapse show item-1" role="tabpanel" data-parent="#accordion-1">
                            <div class="card-body">
                                <a href="#">
                                    <p class="card-text" style="font-size: 14px;margin-top: 0px;margin-bottom: 0px;">Ikatan Adyaksa Dharmakarini</p>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col col-md-6 col-lg-9">
                <h1 style="text-align: center; margin-bottom: 40px;">Ikatan Adyaksa Dharmakarini</h1>
                <hr>

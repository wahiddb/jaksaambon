      ...
      <div class="row">
          ...
          <div class="col col-md-6 col-lg-9">
              ...
              <form method="POST" action="<?= base_url('intelijen/input'); ?>">
                  ...
                  <div class="form-group">
                      <label for="name">Nama Terlapor</label>
                      <input name="terlapor" type="text" class="form-control" id="name" aria-describedby="text" placeholder="Masukkan Nama Terlapor">
                  </div>
                  <div class="form-group">
                      <label for="name">Dugaan Tindak Pidana</label>
                      <input name="tindak_pidana" type="text" class="form-control" id="name" aria-describedby="text" placeholder="Masukkan Dugaan Tindak Pidana Terlapor">
                  </div>
                  <div class="form-group">

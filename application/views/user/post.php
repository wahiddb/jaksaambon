...
<body>
    ...
    <header class="masthead" style="background-image: url(&quot;assets/img/1580775927.png&quot;);">
        <div class="overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    <div class="post-heading">
                        <h1>Penandatanganan Perjanjian Kerjasama tentang Koordinasi dan <br>Kerjasama<br></h1>
                        <h2 class="subheading">Dalam Rangka Penegakan Hukum dan Pemulihan Aset di Bidang Agraria<br><br></h2><span class="meta">Kamis, 20 Januari 2020 18:00</span></div>
                </div>
            </div>
        </div>
    </header>
                ...
                <div class="col-md-10 col-lg-8 mx-auto">
                    ...
                    <blockquote
                        ...
                        <p>As we got further and further away, it [the Earth] diminished in size. Finally it shrank to the size of a marble, the most beautiful you can imagine. That beautiful, warm, living object looked so fragile, so delicate, that if you
                            touched it with a finger it would crumble and fall apart. Seeing this has to change a man.</p><a href="#"><img class="img-fluid" src="<?= base_url('assets'); ?>/img/1580373703.png"></a><span class="caption text-muted">To go places and do things that have never been done before – that’s what living is all about.</span>
